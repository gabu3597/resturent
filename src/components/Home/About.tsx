...
const About: React.FC = () => {
  ...
  const images = [
    { src: "../../assets/about-1.jpg", delay: 0.1, classes: "w-100", alignment: "text-start" },
    { src: "../../assets/about-2.jpg", delay: 0.3, classes: "w-75", alignment: "text-start", style: { marginTop: '25%' } },
    { src: "../../assets/about-3.jpg", delay: 0.5, classes: "w-75", alignment: "text-end" },
    { src: "../../assets/about-4.jpg", delay: 0.7, classes: "w-100", alignment: "text-end" }
  ];
